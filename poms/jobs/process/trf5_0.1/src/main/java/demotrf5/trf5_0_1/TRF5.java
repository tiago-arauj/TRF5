...
public class TRF5 implements TalendJob {
	...
	public void Processos_Ingestao_Bronze_1_tS3Put_1_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void Processos_Ingestao_Bronze_1_tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		mdc("Processos_Ingestao_Bronze_1_tDBInput_1", "gJE6E2_");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_Processos_Ingestao_Bronze_1_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("PASS" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:Pocye4+IT061WI0npGVE+/SbeRbfqMUtzDtHhvNQv7FZKh8vWQ==")
											.substring(0, 4)
									+ "...");
							log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
							...
							log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    \\\"public\\\".\\\"processos_judiciais\\\".\\\"id_processo\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"num_processo\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"data_abertura\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"classe\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"tribunal\\\"  FROM \\\"public\\\".\\\"processos_judiciais\\\"\"");
							log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
							log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1
				...
				final String decryptedPassword_Processos_Ingestao_Bronze_1_tDBInput_1 = java.util.Optional
						.ofNullable(routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:5LkUrE0oUflX2SmnVB/4kDbE8gytAVsNCW49CuESjJc6Sh2pSg=="))
						.orElse("");
	...
	public void Processos_Ingestao_Bronze_1_tS3Put_1Process(final java.util.Map<String, Object> globalMap)
			throws TalendException {
		globalMap.put("Processos_Ingestao_Bronze_1_tS3Put_1_SUBPROCESS_STATE", 0);

		final boolean execStat = this.execStat;

		mdc("Processos_Ingestao_Bronze_1_tS3Put_1", "bpn1uy_");
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_Processos_Ingestao_Bronze_1_tS3Put_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1
									.append("configuration.key" + " = " + "bronze/processos_judiciais.parquet");
							log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
				...
				if (config_from_connection_Processos_Ingestao_Bronze_1_tS3Put_1 != null
					...
					final String prefix_Processos_Ingestao_Bronze_1_tS3Put_1 = config_from_connection_Processos_Ingestao_Bronze_1_tS3Put_1
							...
							.map(key_Processos_Ingestao_Bronze_1_tS3Put_1 -> key_Processos_Ingestao_Bronze_1_tS3Put_1
									.substring(0, key_Processos_Ingestao_Bronze_1_tS3Put_1.lastIndexOf(".__version")))
							.orElse(null);
...
//Standalone begin stub
	...
	public void Processos_Ingestao_Bronze_1_tS3Connection_2Process(final java.util.Map<String, Object> globalMap)
		...
		mdc("Processos_Ingestao_Bronze_1_tS3Connection_2", "3bzXUr_");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(
									"configuration.staticCredentialConfiguration.secretKey" + " = " + String.valueOf(
											"enc:routine.encryption.key.v1:I9vTJ+5wxHmHm+FVhEBL+4J2x3bp4VNDdSQPFpETC48Xjwuoa/77gbvnEMUs1S0mwmm8bR2f2YrsCB502ZO7LS9Z8XQ=")
											.substring(0, 4) + "...");
							log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
							log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2
				...
				s_Processos_Ingestao_Bronze_1_tS3Connection_2.put(
						...
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:wMVrEFJQ3ST8VIoJfTK0oRk1575nOS96Utly39FNWGoXIbf6ualkEIvoCVZm4Pyt4sk+Pkk6MODMMXQco/6WbUoX+Uo="));
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2026-03-13T14:23:10.758111300Z");
...
/************************************************************************************************
 * 144861 characters generated by Qlik Talend Cloud Enterprise Edition on the 13
 * de março de 2026 11:23:10 BRT
 ************************************************************************************************/