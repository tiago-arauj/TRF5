...
public class TRF5 implements TalendJob {
	static {System.setProperty("TalendJob.log", "TRF5.log");}
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_mceAMB7SEfG99Y5mkdgJFg", "0.1");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if(enableLogStash) {
			...
			public void Processos_Ingestao_Bronze_1_tDBInput_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void Processos_Ingestao_Bronze_1_tFileOutputParquet_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void Processos_Ingestao_Bronze_1_tS3Put_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					Processos_Ingestao_Bronze_1_tS3Put_1_onSubJobError(exception, errorComponent, globalMap);
			}
			
			public void Processos_Ingestao_Bronze_1_tS3Connection_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void Processos_Ingestao_Bronze_1_tDBInput_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void Processos_Ingestao_Bronze_1_tS3Put_1_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void Processos_Ingestao_Bronze_1_tS3Connection_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class Processos_Ingestao_Bronze_1_row1Struct implements routines.system.IPersistableRow<Processos_Ingestao_Bronze_1_row1Struct> {
...
public void Processos_Ingestao_Bronze_1_tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("Processos_Ingestao_Bronze_1_tDBInput_1_SUBPROCESS_STATE", 0);

	final boolean execStat = this.execStat;

		mdc("Processos_Ingestao_Bronze_1_tDBInput_1", "c087uR_");
	...
	s(currentComponent="Processos_Ingestao_Bronze_1_tFileOutputParquet_1");
			...
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"Processos_Ingestao_Bronze_1_row1");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_Processos_Ingestao_Bronze_1_tFileOutputParquet_1{
                    ...
                    log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("Parameters:");
                            log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("FILENAME" + " = " + "\"C:/Users/arauj/Documents/NEXUDATA/08. PetaCorp/POC's/Dados/TRF5/Data/processo_bronze\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("FILE_ACTION" + " = " + "OVERWRITE");
                        log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("COMPRESSION" + " = " + "\"UNCOMPRESSED\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("USE_EXTERNAL_HADOOP_DEPS" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("ROW_GROUP_SIZE" + " = " + "134217728");
                        log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("PAGE_SIZE" + " = " + "1048576");
                        log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append(" | ");
                if(log.isDebugEnabled())
            log.debug("Processos_Ingestao_Bronze_1_tFileOutputParquet_1 - "  + (log4jParamters_Processos_Ingestao_Bronze_1_tFileOutputParquet_1) );
                    } 
                } 
        ...
        class ParameterUtil_Processos_Ingestao_Bronze_1_tFileOutputParquet_1{
            ...
            public java.util.Map<String, String> getParameter(final Processos_Ingestao_Bronze_1_row1Struct Processos_Ingestao_Bronze_1_row1) throws Exception{
                java.util.Map<String, String> component_parameters = new java.util.HashMap<>();
                
                try {
                
                            component_parameters.put("FILENAME", String.valueOf("C:/Users/arauj/Documents/NEXUDATA/08. PetaCorp/POC's/Dados/TRF5/Data/processo_bronze"));
        ...
        talendJobLog.addComponentParameterMessage("Processos_Ingestao_Bronze_1_tFileOutputParquet_1", "tFileOutputParquet",
          new ParameterUtil_Processos_Ingestao_Bronze_1_tFileOutputParquet_1().getParameter(Processos_Ingestao_Bronze_1_row1));
        talendJobLogProcess(globalMap);
        s(currentComponent);
        }
        // QTUP-3575
			...
			if(enableLogStash) {
				talendJobLog.addCM("Processos_Ingestao_Bronze_1_tFileOutputParquet_1", "tFileOutputParquet_1", "tFileOutputParquet");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
				...
				org.apache.parquet.schema.Types.MessageTypeBuilder schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = org.apache.parquet.schema.Types.buildMessage();
				...
				globalMap.put("Processos_Ingestao_Bronze_1_tFileOutputParquet_1_FILE_PATH", filePath_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
				...
				config_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.set("fs.file.impl", org.apache.hadoop.fs.LocalFileSystem.class.getName());
				org.apache.hadoop.fs.Path path_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = new org.apache.hadoop.fs.Path(filePath_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
				//CRC file path
				String crcName_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = "."+path_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.getName()+".crc";
				org.apache.hadoop.fs.Path crcPath_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = new org.apache.hadoop.fs.Path(path_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.getParent(),crcName_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
				...
				java.util.Map<String,org.talend.parquet.data.simple.SimpleGroupFactory> cachedFactory_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 =new java.util.HashMap<>();
							schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.addField(org.talend.parquet.utils.TalendParquetUtils.createPrimitiveType("id_processo",false,"INT32","INT_32"));
						    schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.addField(org.talend.parquet.utils.TalendParquetUtils.createPrimitiveType("num_processo",false,"BINARY","UTF8"));
							schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.addField(org.talend.parquet.utils.TalendParquetUtils.createPrimitiveType("data_abertura",false,"INT64","TIMESTAMP_MILLIS"));
						    schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.addField(org.talend.parquet.utils.TalendParquetUtils.createPrimitiveType("classe",true,"BINARY","UTF8"));
						    schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.addField(org.talend.parquet.utils.TalendParquetUtils.createPrimitiveType("tribunal",true,"BINARY","UTF8"));
                	messageType_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = schemaBuilder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.named("Schema");

					org.talend.parquet.hadoop.TalendGroupWriteSupport.setSchema(messageType_Processos_Ingestao_Bronze_1_tFileOutputParquet_1,config_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
				    factory_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = new org.talend.parquet.data.simple.SimpleGroupFactory(messageType_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
					org.apache.parquet.hadoop.ParquetWriter.Builder<org.talend.parquet.data.Group, org.talend.parquet.hadoop.TalendParquetWriter.Builder> builder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 
					    = org.talend.parquet.hadoop.TalendParquetWriter.builder(org.apache.parquet.hadoop.util.HadoopOutputFile.fromPath(path_Processos_Ingestao_Bronze_1_tFileOutputParquet_1, config_Processos_Ingestao_Bronze_1_tFileOutputParquet_1));
					builder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.withWriteMode(org.apache.parquet.hadoop.ParquetFileWriter.Mode.OVERWRITE)
					.withCompressionCodec(org.apache.parquet.hadoop.metadata.CompressionCodecName.fromConf(compressName_Processos_Ingestao_Bronze_1_tFileOutputParquet_1))
			        ...
			        writer_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = builder_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.build();
 ...
 */
	...
	s(currentComponent="Processos_Ingestao_Bronze_1_tDBInput_1");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_Processos_Ingestao_Bronze_1_tDBInput_1{
                    ...
                    log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("Parameters:");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("USE_EXISTING_CONNECTION" + " = " + "false");
                        ...
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("HOST" + " = " + "\"peta-demo-qlik-instance-1.cb64q4o4ssoa.us-east-2.rds.amazonaws.com\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("PORT" + " = " + "\"5432\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("DBNAME" + " = " + "\"qlik_demo\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("SCHEMA_DB" + " = " + "\"public\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("USER" + " = " + "\"peta_qlik\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("PASS" + " = " + String.valueOf("enc:routine.encryption.key.v1:j1Geha2WgI8edo9Wimx62cDZdo+FGq5+9JyTsU39sNoh1yMiPA==").substring(0, 4) + "...");     
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"public\\\".\\\"processos_judiciais\\\".\\\"id_processo\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"num_processo\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"data_abertura\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"classe\\\",    \\\"public\\\".\\\"processos_judiciais\\\".\\\"tribunal\\\"  FROM \\\"public\\\".\\\"processos_judiciais\\\"\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("SPECIFY_DATASOURCE_ALIAS" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("PROPERTIES" + " = " + "\"processos_judiciais\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("id_processo")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("num_processo")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("data_abertura")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("classe")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("tribunal")+"}]");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append("UNIFIED_COMPONENTS" + " = " + "tPostgresqlInput");
                        log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1.append(" | ");
                if(log.isDebugEnabled())
            log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - "  + (log4jParamters_Processos_Ingestao_Bronze_1_tDBInput_1) );
                    } 
                } 
        ...
        class ParameterUtil_Processos_Ingestao_Bronze_1_tDBInput_1{
            ...
            public java.util.Map<String, String> getParameter() throws Exception{
                ...
                try {
                            ...
                            component_parameters.put("HOST", String.valueOf("peta-demo-qlik-instance-1.cb64q4o4ssoa.us-east-2.rds.amazonaws.com"));
                            ...
                            component_parameters.put("QUERY", String.valueOf(new StringBuilder().append("SELECT \n  \"public\".\"processos_judiciais\".\"id_processo\", \n  \"public\".\"processos_judiciais\".\"num_processo\", \n" +"  \"public\".\"processos_judiciais\".\"data_abertura\", \n  \"public\".\"processos_judiciais\".\"classe\", \n  \"public\"." +"\"processos_judiciais\".\"tribunal\"\n FROM \"public\".\"processos_judiciais\"").toString()));
                            ...
                            component_parameters.put("TRIM_COLUMN", String.valueOf(new StringBuilder().append("[{TRIM=").append("false").append(", SCHEMA_COLUMN=").append("id_processo").append("}, {TRIM=").append("false").append(", SCHEMA_COLUMN=").append("num_processo").append("}, {TRIM=").append("false").append(", SCHEMA_COLUMN=").append("data_abertura").append("}, {TRIM=").append("false").append(", SCHEMA_COLUMN=").append("classe").append("}, {TRIM=").append("false").append(", SCHEMA_COLUMN=").append("tribunal").append("}]").toString()));
        ...
        talendJobLog.addComponentParameterMessage("Processos_Ingestao_Bronze_1_tDBInput_1", "tPostgresqlInput",
        ...
        // QTUP-3575
		    ...
		    java.sql.Connection conn_Processos_Ingestao_Bronze_1_tDBInput_1 = null;
			    ...
			    java.lang.Class jdbcclazz_Processos_Ingestao_Bronze_1_tDBInput_1 = java.lang.Class.forName(driverClass_Processos_Ingestao_Bronze_1_tDBInput_1);
				String dbUser_Processos_Ingestao_Bronze_1_tDBInput_1 = "peta_qlik";
				
				 
	final String decryptedPassword_Processos_Ingestao_Bronze_1_tDBInput_1 = java.util.Optional.ofNullable(routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Ku24D2Xup+mFpIRzb2rY28N8xYcQrVQVoC+OMa6WmAlv57IeSA==")).orElse("");
				
				String dbPwd_Processos_Ingestao_Bronze_1_tDBInput_1 = decryptedPassword_Processos_Ingestao_Bronze_1_tDBInput_1;
				
				String url_Processos_Ingestao_Bronze_1_tDBInput_1 = "jdbc:postgresql://" + "peta-demo-qlik-instance-1.cb64q4o4ssoa.us-east-2.rds.amazonaws.com" + ":" + "5432" + "/" + "qlik_demo" + "?" + "processos_judiciais";
				
	    		log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - Driver ClassName: "+driverClass_Processos_Ingestao_Bronze_1_tDBInput_1+".");
			
	    		log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - Connection attempt to '" + url_Processos_Ingestao_Bronze_1_tDBInput_1.replaceAll("(?<=trustStorePassword=)[^;]*", "********") + "' with the username '" + dbUser_Processos_Ingestao_Bronze_1_tDBInput_1 + "'.");
			
				conn_Processos_Ingestao_Bronze_1_tDBInput_1 = java.sql.DriverManager.getConnection(url_Processos_Ingestao_Bronze_1_tDBInput_1,dbUser_Processos_Ingestao_Bronze_1_tDBInput_1,dbPwd_Processos_Ingestao_Bronze_1_tDBInput_1);
	    		log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - Connection to '" + url_Processos_Ingestao_Bronze_1_tDBInput_1.replaceAll("(?<=trustStorePassword=)[^;]*", "********") + "' has succeeded.");
			...
			java.sql.Statement stmt_Processos_Ingestao_Bronze_1_tDBInput_1 = conn_Processos_Ingestao_Bronze_1_tDBInput_1.createStatement();

		    String dbquery_Processos_Ingestao_Bronze_1_tDBInput_1 = new StringBuilder().append("SELECT \n  \"public\".\"processos_judiciais\".\"id_processo\", \n  \"public\".\"processos_judiciais\".\"num_processo\", \n"
+"  \"public\".\"processos_judiciais\".\"data_abertura\", \n  \"public\".\"processos_judiciais\".\"classe\", \n  \"public\"."
+"\"processos_judiciais\".\"tribunal\"\n FROM \"public\".\"processos_judiciais\"").toString();
		    
	    		log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - Executing the query: '" + dbquery_Processos_Ingestao_Bronze_1_tDBInput_1 + "'.");
			

		    globalMap.put("Processos_Ingestao_Bronze_1_tDBInput_1_QUERY",dbquery_Processos_Ingestao_Bronze_1_tDBInput_1);

		    java.sql.ResultSet rs_Processos_Ingestao_Bronze_1_tDBInput_1 = null;

		    try {
		    	rs_Processos_Ingestao_Bronze_1_tDBInput_1 = stmt_Processos_Ingestao_Bronze_1_tDBInput_1.executeQuery(dbquery_Processos_Ingestao_Bronze_1_tDBInput_1);
		    	java.sql.ResultSetMetaData rsmd_Processos_Ingestao_Bronze_1_tDBInput_1 = rs_Processos_Ingestao_Bronze_1_tDBInput_1.getMetaData();
		    	int colQtyInRs_Processos_Ingestao_Bronze_1_tDBInput_1 = rsmd_Processos_Ingestao_Bronze_1_tDBInput_1.getColumnCount();
            ...
            Processos_Ingestao_Bronze_1_row1.id_processo = rs_Processos_Ingestao_Bronze_1_tDBInput_1.getInt(1);
        	...
        	Processos_Ingestao_Bronze_1_row1.num_processo = routines.system.JDBCUtil.getString(rs_Processos_Ingestao_Bronze_1_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_Processos_Ingestao_Bronze_1_tDBInput_1 < 3) {
								Processos_Ingestao_Bronze_1_row1.data_abertura = null;
							} else {
										
			Processos_Ingestao_Bronze_1_row1.data_abertura = routines.system.JDBCUtil.getDate(rs_Processos_Ingestao_Bronze_1_tDBInput_1, 3);
		                    }
							if(colQtyInRs_Processos_Ingestao_Bronze_1_tDBInput_1 < 4) {
								Processos_Ingestao_Bronze_1_row1.classe = null;
							} else {
	                         		
        	Processos_Ingestao_Bronze_1_row1.classe = routines.system.JDBCUtil.getString(rs_Processos_Ingestao_Bronze_1_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_Processos_Ingestao_Bronze_1_tDBInput_1 < 5) {
								Processos_Ingestao_Bronze_1_row1.tribunal = null;
							} else {
	                         		
        	Processos_Ingestao_Bronze_1_row1.tribunal = routines.system.JDBCUtil.getString(rs_Processos_Ingestao_Bronze_1_tDBInput_1, 5, false);
		                    }
					
						log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - Retrieving the record " + nb_line_Processos_Ingestao_Bronze_1_tDBInput_1 + ".");
 ...
 */
	...
	s(currentComponent="Processos_Ingestao_Bronze_1_tDBInput_1");
      ...
      class SchemaUtil_Processos_Ingestao_Bronze_1_row1 {
          ...
          public java.util.List<java.util.Map<String, String>> getSchema(final Processos_Ingestao_Bronze_1_row1Struct Processos_Ingestao_Bronze_1_row1) {
              java.util.List<java.util.Map<String, String>> s = new java.util.ArrayList<>();
              if(Processos_Ingestao_Bronze_1_row1 == null) {
                  return s;
              }
              a(s,"id_processo","id_processo","true","id_Integer","SERIAL","false","","10","0");
              a(s,"num_processo","num_processo","false","id_String","VARCHAR","false","","25","0");
              a(s,"data_abertura","data_abertura","false","id_Date","DATE","false","dd-MM-yyyy","13","0");
              a(s,"classe","classe","false","id_String","VARCHAR","true","","100","0");
              a(s,"tribunal","tribunal","false","id_String","VARCHAR","true","","10","0");
              return s;
          }
      ...
      if(Processos_Ingestao_Bronze_1_row1 != null) {
          talendJobLog.addConnectionSchemaMessage("Processos_Ingestao_Bronze_1_tDBInput_1","tPostgresqlInput",
            "Processos_Ingestao_Bronze_1_tFileOutputParquet_1","tFileOutputParquet", "Processos_Ingestao_Bronze_1_row1" + iterateId, new SchemaUtil_Processos_Ingestao_Bronze_1_row1().getSchema(Processos_Ingestao_Bronze_1_row1));
          talendJobLogProcess(globalMap);
 ...
 */
	...
	s(currentComponent="Processos_Ingestao_Bronze_1_tFileOutputParquet_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"Processos_Ingestao_Bronze_1_row1","Processos_Ingestao_Bronze_1_tDBInput_1","tDBInput_1","tPostgresqlInput","Processos_Ingestao_Bronze_1_tFileOutputParquet_1","tFileOutputParquet_1","tFileOutputParquet"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("Processos_Ingestao_Bronze_1_row1 - " + (Processos_Ingestao_Bronze_1_row1==null? "": Processos_Ingestao_Bronze_1_row1.toLogString()));
    			}
    		
	
                org.talend.parquet.data.Group group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = factory_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.newGroup();
	                
								group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("id_processo",Processos_Ingestao_Bronze_1_row1.id_processo);
                    	if(Processos_Ingestao_Bronze_1_row1.num_processo != null) {
                  	
								group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("num_processo",String.valueOf(Processos_Ingestao_Bronze_1_row1.num_processo));
                    	}
                  	
                    	if(Processos_Ingestao_Bronze_1_row1.data_abertura != null) {
                  	
                            	if(messageType_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.getType("data_abertura").isPrimitive() && org.apache.parquet.schema.PrimitiveType.PrimitiveTypeName.INT64 == messageType_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.getType("data_abertura").asPrimitiveType().getPrimitiveTypeName()){
                                	group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("data_abertura", Processos_Ingestao_Bronze_1_row1.data_abertura.getTime());
                                }else{
                                	group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("data_abertura", FormatterUtils.format_Date(Processos_Ingestao_Bronze_1_row1.data_abertura, "dd-MM-yyyy"));
                                }
                    	}
                  	
                    	if(Processos_Ingestao_Bronze_1_row1.classe != null) {
                  	
								group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("classe",String.valueOf(Processos_Ingestao_Bronze_1_row1.classe));
                    	}
                  	
                    	if(Processos_Ingestao_Bronze_1_row1.tribunal != null) {
                  	
								group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.append("tribunal",String.valueOf(Processos_Ingestao_Bronze_1_row1.tribunal));
                    	}
                  	
            	writer_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.write(group_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
            	nb_line_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 ++;
				log.debug("Processos_Ingestao_Bronze_1_tFileOutputParquet_1 - Writing the record " + nb_line_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 + " to the file.");
 ...
 */
	...
	if(conn_Processos_Ingestao_Bronze_1_tDBInput_1 != null && !conn_Processos_Ingestao_Bronze_1_tDBInput_1.isClosed()) {
...
globalMap.put("Processos_Ingestao_Bronze_1_tDBInput_1_NB_LINE",nb_line_Processos_Ingestao_Bronze_1_tDBInput_1);
	    		log.debug("Processos_Ingestao_Bronze_1_tDBInput_1 - Retrieved records count: "+nb_line_Processos_Ingestao_Bronze_1_tDBInput_1 + " .");
 ...
 */
	...
	s(currentComponent="Processos_Ingestao_Bronze_1_tFileOutputParquet_1");
				...
				globalMap.put("Processos_Ingestao_Bronze_1_tFileOutputParquet_1_NB_LINE",nb_line_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);

				log.debug("Processos_Ingestao_Bronze_1_tFileOutputParquet_1 - Written records count: " + nb_line_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 + " .");
				...
				org.apache.hadoop.fs.FileSystem fs_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 = crcPath_Processos_Ingestao_Bronze_1_tFileOutputParquet_1.getFileSystem(config_Processos_Ingestao_Bronze_1_tFileOutputParquet_1);
                if(fs_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 .exists(crcPath_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 )) {
			        fs_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 .delete(crcPath_Processos_Ingestao_Bronze_1_tFileOutputParquet_1 , false);
			    }


			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"Processos_Ingestao_Bronze_1_row1",2,0,
			 			"Processos_Ingestao_Bronze_1_tDBInput_1","tDBInput_1","tPostgresqlInput","Processos_Ingestao_Bronze_1_tFileOutputParquet_1","tFileOutputParquet_1","tFileOutputParquet","output")) {
						talendJobLogProcess(globalMap);
					}
...
end_Hash.put("Processos_Ingestao_Bronze_1_tFileOutputParquet_1", System.currentTimeMillis());
				...
				if(execStat){   
   	 				runStat.updateStatOnConnection("Processos_Ingestao_Bronze_1_OnComponentOk1", 0, "ok");
				}
				Processos_Ingestao_Bronze_1_tS3Put_1Process(globalMap);
...
public void Processos_Ingestao_Bronze_1_tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("Processos_Ingestao_Bronze_1_tS3Put_1_SUBPROCESS_STATE", 0);

	final boolean execStat = this.execStat;

		mdc("Processos_Ingestao_Bronze_1_tS3Put_1", "oLVgjF_");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_Processos_Ingestao_Bronze_1_tS3Put_1{
                    ...
                    log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("Parameters:");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.bucket" + " = " + "peta-demo-qlik");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.key" + " = " + "bronze/processos_judiciais.parquet");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.file" + " = " + "\"C:/Users/arauj/Documents/NEXUDATA/08. PetaCorp/POC's/Dados/TRF5/Data/processo_bronze\"");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.enableServerSideEncryption" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.dieOnError" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.multipartThreshold" + " = " + "5");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.partSize" + " = " + "5");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.cannedAccessControlList" + " = " + "NONE");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.enableObjectLock" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("configuration.setObjectTags" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("USE_EXISTING_CONNECTION" + " = " + "true");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append("CONNECTION" + " = " + "Processos_Ingestao_Bronze_1_tS3Connection_2");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1.append(" | ");
                if(log.isDebugEnabled())
            log.debug("Processos_Ingestao_Bronze_1_tS3Put_1 - "  + (log4jParamters_Processos_Ingestao_Bronze_1_tS3Put_1) );
                    } 
                } 
        ...
        class ParameterUtil_Processos_Ingestao_Bronze_1_tS3Put_1{
            ...
            public java.util.Map<String, String> getParameter() throws Exception{
                ...
                try {
                    ...
                    component_parameters.put("configuration.key", "bronze/processos_judiciais.parquet");


                    component_parameters.put("configuration.file", "C:/Users/arauj/Documents/NEXUDATA/08. PetaCorp/POC's/Dados/TRF5/Data/processo_bronze");
                    ...
                    component_parameters.put("configuration.setObjectTags", "false");
                            ...
                            component_parameters.put("CONNECTION", String.valueOf("Processos_Ingestao_Bronze_1_tS3Connection_2"));
...
final org.talend.sdk.component.runtime.manager.ComponentManager mgr_Processos_Ingestao_Bronze_1_tS3Put_1 = org.talend.sdk.component.runtime.manager.ComponentManager.instance();
...
final class SettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1 {
    ...
    SettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1(final java.util.Map<String, String> configuration) {
...
final SettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1 s_Processos_Ingestao_Bronze_1_tS3Put_1 = new SettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1(configuration_Processos_Ingestao_Bronze_1_tS3Put_1);
Object dv_Processos_Ingestao_Bronze_1_tS3Put_1;
java.net.URL mappings_url_Processos_Ingestao_Bronze_1_tS3Put_1= this.getClass().getResource("/xmlMappings");
globalMap.put("Processos_Ingestao_Bronze_1_tS3Put_1_MAPPINGS_URL", mappings_url_Processos_Ingestao_Bronze_1_tS3Put_1);
...
globalMap.putIfAbsent("TALEND_AWS_TRACKER", "APN/1.0 Talend/8.0 Studio/8.0 (Qlik Talend Cloud)");
                ...
                s_Processos_Ingestao_Bronze_1_tS3Put_1.put("configuration.key", "bronze/processos_judiciais.parquet");

                s_Processos_Ingestao_Bronze_1_tS3Put_1.put("configuration.file", "C:/Users/arauj/Documents/NEXUDATA/08. PetaCorp/POC's/Dados/TRF5/Data/processo_bronze");
                ...
                s_Processos_Ingestao_Bronze_1_tS3Put_1.put("configuration.dataset.datastore.__version", "-1");
                        ...
                        new SchemaSettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1_1().set(configuration_Processos_Ingestao_Bronze_1_tS3Put_1);
                        final class SchemaSettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1_2 {
                        
                        public void set(final java.util.Map<String, String> configuration) throws java.lang.Exception {
                        }
                        }
                        new SchemaSettingHelper_Processos_Ingestao_Bronze_1_tS3Put_1_2().set(configuration_Processos_Ingestao_Bronze_1_tS3Put_1);
            final java.util.Map<String, String> config_from_connection_Processos_Ingestao_Bronze_1_tS3Put_1 = (java.util.Map<String, String>)globalMap.get("configuration_Processos_Ingestao_Bronze_1_tS3Connection_2");
            final String conn_param_prefix_Processos_Ingestao_Bronze_1_tS3Put_1 = "configuration.dataset.datastore";
            if(config_from_connection_Processos_Ingestao_Bronze_1_tS3Put_1!=null && conn_param_prefix_Processos_Ingestao_Bronze_1_tS3Put_1!=null) {
                final String prefix_Processos_Ingestao_Bronze_1_tS3Put_1 = config_from_connection_Processos_Ingestao_Bronze_1_tS3Put_1.keySet().stream()
                    .filter(key_Processos_Ingestao_Bronze_1_tS3Put_1 -> key_Processos_Ingestao_Bronze_1_tS3Put_1.endsWith(".__version"))
                    .findFirst()
                    .map(key_Processos_Ingestao_Bronze_1_tS3Put_1 -> key_Processos_Ingestao_Bronze_1_tS3Put_1.substring(0, key_Processos_Ingestao_Bronze_1_tS3Put_1.lastIndexOf(".__version")))
                    .orElse(null);
                    
                if(prefix_Processos_Ingestao_Bronze_1_tS3Put_1!=null) {
                    config_from_connection_Processos_Ingestao_Bronze_1_tS3Put_1.entrySet().stream().filter(entry_Processos_Ingestao_Bronze_1_tS3Put_1->entry_Processos_Ingestao_Bronze_1_tS3Put_1.getKey().startsWith(prefix_Processos_Ingestao_Bronze_1_tS3Put_1)).forEach(entry_Processos_Ingestao_Bronze_1_tS3Put_1->{
                        configuration_Processos_Ingestao_Bronze_1_tS3Put_1.put(entry_Processos_Ingestao_Bronze_1_tS3Put_1.getKey().replaceFirst(prefix_Processos_Ingestao_Bronze_1_tS3Put_1, conn_param_prefix_Processos_Ingestao_Bronze_1_tS3Put_1), entry_Processos_Ingestao_Bronze_1_tS3Put_1.getValue());
                    });
                }
            }

final org.talend.sdk.component.runtime.standalone.DriverRunner standalone_Processos_Ingestao_Bronze_1_tS3Put_1 = mgr_Processos_Ingestao_Bronze_1_tS3Put_1.findDriverRunner("S3", "Put", 1, configuration_Processos_Ingestao_Bronze_1_tS3Put_1)
    .orElseThrow(() -> new IllegalArgumentException("Can't find S3#Put"));

org.talend.sdk.component.runtime.di.studio.RuntimeContextInjector.injectLifecycle(standalone_Processos_Ingestao_Bronze_1_tS3Put_1, new org.talend.sdk.component.api.context.RuntimeContextHolder("Processos_Ingestao_Bronze_1_tS3Put_1", globalMap));

try {
    java.lang.reflect.Field field_Processos_Ingestao_Bronze_1_tS3Put_1 = standalone_Processos_Ingestao_Bronze_1_tS3Put_1.getClass().getSuperclass().getDeclaredField("delegate");
    if (!field_Processos_Ingestao_Bronze_1_tS3Put_1.isAccessible()) {
        field_Processos_Ingestao_Bronze_1_tS3Put_1.setAccessible(true);
    }
    Object v_Processos_Ingestao_Bronze_1_tS3Put_1 = field_Processos_Ingestao_Bronze_1_tS3Put_1.get(standalone_Processos_Ingestao_Bronze_1_tS3Put_1);
    Object con_Processos_Ingestao_Bronze_1_tS3Put_1 = globalMap.get("conn_Processos_Ingestao_Bronze_1_tS3Connection_2");
    if(con_Processos_Ingestao_Bronze_1_tS3Put_1==null) {
        throw new RuntimeException("can't find the connection object");
    }

    Class<?> current_Processos_Ingestao_Bronze_1_tS3Put_1 = v_Processos_Ingestao_Bronze_1_tS3Put_1.getClass();
    while (current_Processos_Ingestao_Bronze_1_tS3Put_1 != null && current_Processos_Ingestao_Bronze_1_tS3Put_1 != Object.class) {
        java.util.stream.Stream.of(current_Processos_Ingestao_Bronze_1_tS3Put_1.getDeclaredFields()).filter(f_Processos_Ingestao_Bronze_1_tS3Put_1 -> f_Processos_Ingestao_Bronze_1_tS3Put_1.isAnnotationPresent(org.talend.sdk.component.api.service.connection.Connection.class)).forEach(f_Processos_Ingestao_Bronze_1_tS3Put_1 -> {
            if (!f_Processos_Ingestao_Bronze_1_tS3Put_1.isAccessible()) {
                f_Processos_Ingestao_Bronze_1_tS3Put_1.setAccessible(true);
            }
            try {
                f_Processos_Ingestao_Bronze_1_tS3Put_1.set(v_Processos_Ingestao_Bronze_1_tS3Put_1, con_Processos_Ingestao_Bronze_1_tS3Put_1);
        ...
        current_Processos_Ingestao_Bronze_1_tS3Put_1 = current_Processos_Ingestao_Bronze_1_tS3Put_1.getSuperclass();
    }
...
globalMap.put("standalone_Processos_Ingestao_Bronze_1_tS3Put_1", standalone_Processos_Ingestao_Bronze_1_tS3Put_1);
...
final org.talend.sdk.component.runtime.standalone.DriverRunner standalone_Processos_Ingestao_Bronze_1_tS3Put_1 = org.talend.sdk.component.runtime.standalone.DriverRunner.class.cast(globalMap.remove("standalone_Processos_Ingestao_Bronze_1_tS3Put_1"));
try {
    if (standalone_Processos_Ingestao_Bronze_1_tS3Put_1 != null) {
        standalone_Processos_Ingestao_Bronze_1_tS3Put_1.stop();
    }
 ...
 */
		...
		globalMap.put("Processos_Ingestao_Bronze_1_tS3Put_1_SUBPROCESS_STATE", 1);
	}
	


public void Processos_Ingestao_Bronze_1_tS3Connection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("Processos_Ingestao_Bronze_1_tS3Connection_2_SUBPROCESS_STATE", 0);

	final boolean execStat = this.execStat;

		mdc("Processos_Ingestao_Bronze_1_tS3Connection_2", "5wC1Ah_");
	...
	s(currentComponent="Processos_Ingestao_Bronze_1_tS3Connection_2");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_Processos_Ingestao_Bronze_1_tS3Connection_2{
                    ...
                    log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("Parameters:");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.credentialProvider" + " = " + "STATIC_CREDENTIALS");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.staticCredentialConfiguration.accessKey" + " = " + "AKIAUWW4VRZLOLIPY4ZH");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.staticCredentialConfiguration.secretKey" + " = " + String.valueOf("enc:routine.encryption.key.v1:Dctf4GGOYl08k6sQdlnuWz4m3hDw/HVmZ9BWQXeulIhMRnbEwaCgsNhWoaihoCPo/det5z4gJgAOsmcO42OqmEJik8E=").substring(0, 4) + "...");     
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.assumeRole" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.region" + " = " + "DEFAULT");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.clientSideEncrypt" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.useRegionEndpoint" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.configClient" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.checkAccessibility" + " = " + "true");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.checkMethod" + " = " + "BY_ACCOUNT_OWNER");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                            log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append("configuration.enableAccelerate" + " = " + "false");
                        log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2.append(" | ");
                if(log.isDebugEnabled())
            log.debug("Processos_Ingestao_Bronze_1_tS3Connection_2 - "  + (log4jParamters_Processos_Ingestao_Bronze_1_tS3Connection_2) );
                    } 
                } 
        ...
        class ParameterUtil_Processos_Ingestao_Bronze_1_tS3Connection_2{
            ...
            public java.util.Map<String, String> getParameter() throws Exception{
                ...
                try {
                    ...
                    component_parameters.put("configuration.staticCredentialConfiguration.accessKey", "AKIAUWW4VRZLOLIPY4ZH");
        ...
        talendJobLog.addComponentParameterMessage("Processos_Ingestao_Bronze_1_tS3Connection_2", "tS3Connection",
        ...
        // QTUP-3575
			...
			if(enableLogStash) {
				talendJobLog.addCM("Processos_Ingestao_Bronze_1_tS3Connection_2", "tS3Connection_2", "tS3Connection");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
final org.talend.sdk.component.runtime.manager.ComponentManager mgr_Processos_Ingestao_Bronze_1_tS3Connection_2 = org.talend.sdk.component.runtime.manager.ComponentManager.instance();
...
final class SettingHelper_Processos_Ingestao_Bronze_1_tS3Connection_2 {
    ...
    SettingHelper_Processos_Ingestao_Bronze_1_tS3Connection_2(final java.util.Map<String, String> configuration) {
        this.configuration = configuration;
    }
...
final SettingHelper_Processos_Ingestao_Bronze_1_tS3Connection_2 s_Processos_Ingestao_Bronze_1_tS3Connection_2 = new SettingHelper_Processos_Ingestao_Bronze_1_tS3Connection_2(configuration_Processos_Ingestao_Bronze_1_tS3Connection_2);
Object dv_Processos_Ingestao_Bronze_1_tS3Connection_2;
java.net.URL mappings_url_Processos_Ingestao_Bronze_1_tS3Connection_2= this.getClass().getResource("/xmlMappings");
globalMap.put("Processos_Ingestao_Bronze_1_tS3Connection_2_MAPPINGS_URL", mappings_url_Processos_Ingestao_Bronze_1_tS3Connection_2);
globalMap.putIfAbsent("TALEND_PRODUCT_VERSION", "8.0");
globalMap.putIfAbsent("TALEND_AWS_TRACKER", "APN/1.0 Talend/8.0 Studio/8.0 (Qlik Talend Cloud)");

                s_Processos_Ingestao_Bronze_1_tS3Connection_2.put("configuration.credentialProvider", "STATIC_CREDENTIALS");

                s_Processos_Ingestao_Bronze_1_tS3Connection_2.put("configuration.staticCredentialConfiguration.accessKey", "AKIAUWW4VRZLOLIPY4ZH");
                s_Processos_Ingestao_Bronze_1_tS3Connection_2.put("configuration.staticCredentialConfiguration.secretKey", routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:KgxWpQDJLbCq/aAU5GC3vJPFhjfGyEFHPtt+9M9kXJE3h9qsYV4vRicANc22YlTOIbgGqD1yDIyn23k8cAAkPpp+DmE="));
                ...
                s_Processos_Ingestao_Bronze_1_tS3Connection_2.put("configuration.__version", "-1");
                        ...
                        new SchemaSettingHelper_Processos_Ingestao_Bronze_1_tS3Connection_2_1().set(configuration_Processos_Ingestao_Bronze_1_tS3Connection_2);
...
mgr_Processos_Ingestao_Bronze_1_tS3Connection_2.findPlugin("aws-s3")
    ...
    .getServices()
    .stream()
    .forEach(serviceMeta_Processos_Ingestao_Bronze_1_tS3Connection_2 -> {
        serviceMeta_Processos_Ingestao_Bronze_1_tS3Connection_2.getActions().stream().filter(actionMeta_Processos_Ingestao_Bronze_1_tS3Connection_2 -> "create_connection".equals(actionMeta_Processos_Ingestao_Bronze_1_tS3Connection_2.getType())).forEach(actionMeta_Processos_Ingestao_Bronze_1_tS3Connection_2 -> {
            synchronized (serviceMeta_Processos_Ingestao_Bronze_1_tS3Connection_2.getInstance()) {
                org.talend.sdk.component.runtime.di.studio.RuntimeContextInjector.injectService(mgr_Processos_Ingestao_Bronze_1_tS3Connection_2, "aws-s3", new org.talend.sdk.component.api.context.RuntimeContextHolder("Processos_Ingestao_Bronze_1_tS3Connection_2", globalMap));
                
                Object connnection_Processos_Ingestao_Bronze_1_tS3Connection_2 = actionMeta_Processos_Ingestao_Bronze_1_tS3Connection_2.getInvoker().apply(configuration_Processos_Ingestao_Bronze_1_tS3Connection_2);

                globalMap.put("conn_Processos_Ingestao_Bronze_1_tS3Connection_2", connnection_Processos_Ingestao_Bronze_1_tS3Connection_2);
                
				try{
                configuration_Processos_Ingestao_Bronze_1_tS3Connection_2.put("configuration.staticCredentialConfiguration.secretKey", routines.system.PasswordEncryptUtil.encryptPassword(configuration_Processos_Ingestao_Bronze_1_tS3Connection_2.get("configuration.staticCredentialConfiguration.secretKey")));
				} catch (Exception e) {
						e.printStackTrace();
				}
                globalMap.put("configuration_Processos_Ingestao_Bronze_1_tS3Connection_2", configuration_Processos_Ingestao_Bronze_1_tS3Connection_2);
            }
        });
    });
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'TRF5' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2026-03-13T18:20:49.371809300Z");
		    ...
		    if((lineageDirPath != null && !lineageDirPath.isEmpty()) || (payloadFilePath !=null && !payloadFilePath.isEmpty())) {
		        enableLineage = true;
    			...
    			if(lineageFilePath==null || lineageFilePath.isEmpty()) {
					...
					System.setProperty("runtime.lineage.appender.file.path", 
						...
						.append((finalLineageDirPath.endsWith("/") || finalLineageDirPath.endsWith("\\")) ? "" : java.io.File.separator)
						.append(projectName)
    			...
    			System.getProperties().stringPropertyNames().stream()
    					...
    					.forEach(key -> p_talendJobLog.setProperty(key.substring("runtime.lineage.".length()), System.getProperty(key)));
    			
    			
    			
    			
    			org.apache.logging.log4j.core.config.Configurator.setLevel(p_talendJobLog.getProperty("root.logger"), org.apache.logging.log4j.Level.DEBUG);
    			
    			
    			runtime_lineage_logger_talendJobLog = org.talend.job.audit.JobEventAuditLoggerFactory.createJobAuditLogger(p_talendJobLog);
			}
        ...
        try {
            ...
            java.io.InputStream inContext = TRF5.class.getClassLoader().getResourceAsStream("demotrf5/trf5_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = TRF5.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
try {
errorCode = null;Processos_Ingestao_Bronze_1_tS3Connection_2Process(globalMap);
...
if (execStat) {
    ...
    if(!isChildJob) {
        //TODO TMC need to make sure the key or provide a way to pass it to job, consider java command length too long risk in windows OS
	...
	String taskExecId = System.getProperty("tmc.task.execution.id");
        ...
        try {
            if(lineageFilePath != null && payloadFilePath != null) {
                org.talend.studio.ProducerHelper.newPayload(new java.io.File(payloadFilePath), new java.io.File(lineageFilePath), taskExecId, taskId, taskVersion, lineageDirPath == null ? true : false);
            }
        } catch (java.lang.Exception e) {
            e.printStackTrace();
        }
  ...
  if (null != taskExecutionId && !taskExecutionId.isEmpty()) {
    ...
    private java.util.Map<String, Object> getSharedConnections4REST() {
        java.util.Map<String, Object> connections = new java.util.HashMap<String, Object>();
            ...
            connections.put("conn_Processos_Ingestao_Bronze_1_tS3Connection_2", globalMap.get("conn_Processos_Ingestao_Bronze_1_tS3Connection_2"));
...
/************************************************************************************************
 *     144861 characters generated by Qlik Talend Cloud Enterprise Edition 
 *     on the 13 de março de 2026 15:20:49 BRT
 ************************************************************************************************/